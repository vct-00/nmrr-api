...
const bookingController_1 = __importDefault(
...
router.get(
  ...
  bookingController_1.default.getBookingByUserId
);
//Get all room bookings by Room ID
router.get(
  "/room/:roomId",
  roomController_1.default.validateRoomExists,
  bookingController_1.default.getBookingByRoomId
);
//Add room booking
router.post(
  "/",
  authController_1.default.authorizeToken,
  roomController_1.default.validateRoomExists,
  bookingController_1.default.addBooking
);
